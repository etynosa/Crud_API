...
namespace Crud_API.DomainModels.Base
{
    public sealed class GenericResult<T>
    {
        ...
        /// <param name="itemId">The identifier of item.</param>
        /// <param name="message">Message for metadata.</param>
        public static GenericResult<T> Succeed(T itemId, string message)
        {
            var result = Succeed(itemId);
            result.Metadata.Message = message;
            return result;
        ...
        /// <summary>
        /// Helper to return created successful result with an item with explicit http status code and meessage.
        /// </summary>
        /// <param name="message">The return message.</param>
        public static GenericResult<T> CreatedWithMessage(string message)
        {
            return new GenericResult<T>
            {
                Metadata = new ResponseInfo
        ...
        /// <param name="itemId">The identifier of item.</param>
        /// <param name="message">Message for metadata.</param>
        public static GenericResult<T> Fail(T itemId, string message)
        {
            return new GenericResult<T>
            {
                Metadata = new ResponseInfo
